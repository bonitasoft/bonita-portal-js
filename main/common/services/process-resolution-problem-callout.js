(function() {
   ...
   * Description
   */
  angular.module('org.bonitasoft.service.process.errorMessage', ['gettext'])
    ...
    .service('ProcessProblemResolutionService', function(gettextCatalog, ProcessResolutionProblemItem) {
      ...
      processProblemResolutionService.isActorResolutionFailing = function(problemsStateList) {
        return problemsStateList.indexOf && problemsStateList.indexOf(ProcessResolutionProblemItem.VALUE_STATE_TARGET_TYPE_ACTOR) >= 0;
      };

      processProblemResolutionService.isConnectorResolutionFailing = function(problemsStateList) {
        return  problemsStateList.indexOf && problemsStateList.indexOf(ProcessResolutionProblemItem.VALUE_STATE_TARGET_TYPE_CONNECTOR) >= 0;
      };


      processProblemResolutionService.isParameterResolutionFailing = function(problemsStateList) {
        return problemsStateList.indexOf && problemsStateList.indexOf(ProcessResolutionProblemItem.VALUE_STATE_TARGET_TYPE_PARAMETER) >= 0;
      };
