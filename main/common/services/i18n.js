...
(function () {
  ...
  angular.module('org.bonitasoft.services.i18n', [
    ...
    'processDetails.pm.mapping.update.error': '{{nbMapping}} Process manager mappings could not be deleted',
    'processDetails.pm.mapping.update.success': '{{nbMapping}} Process manager mappings have been deleted',
