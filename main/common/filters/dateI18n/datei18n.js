(function() {
  ...
  angular.module('com.bonita.common.i18n.filters',['gettext'])
    ...
    .filter('dateI18n', ['$window', 'gettextCatalog', function ($window, gettextCatalog) {
      return function translateDate(input, output) {
        ...
        if(!output) {
          throw new Error('[com.bonita.common.i18n.filters@dateI18nFilter] You cannot use the date filter without a format');
        }

        if(!$window.moment) {
          throw new Error('[com.bonita.common.i18n.filters@dateI18nFilter] We need moment.js to translate our dates');
        }
    ...
    .filter('dateAgo', ['$window', 'gettextCatalog', function ($window, gettextCatalog) {
      return function dateAgo(input) {
        ...
        if(!$window.moment) {
          throw new Error('[com.bonita.common.i18n.filters@dateAgoFilter] We need moment.js to translate our dates');
        }
