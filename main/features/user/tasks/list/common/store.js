      ...
      function(ArchivedFlowNode, Case, Comment, Process, ProcessSupervisor, ProfessionalData, $q, TASK_FILTERS, taskRequest){
        ...
        this.getProcessList = function(){
          ...
          var promise = Process.search(req).$promise
            ...
            .then(function(response){
              store.processes = [{name:'All', id:false}].concat(response.resource);
        ...
        this.getCaseInfo = function(caseId) {
          ...
          var promise = Case.get({id: caseId, d:['started_by','processDefinitionId']}).$promise;
        ...
        this.getProcessSupervisors = function(processId) {
          ...
          var promise = ProcessSupervisor.search({f:['process_id='+processId], c:10, p:0, d:'user_id'}).$promise;
        ...
        this.getComment = function(caseId) {
          ...
          var promise = Comment.search({f:['processInstanceId='+caseId], c:100, p:0, d:'user_id'}).$promise;
        ...
        this.getArchivedFlowNode = function(caseId) {
          ...
          var promise = ArchivedFlowNode.search({f:['caseId='+caseId,'isTerminal=true'], c:100, p:0, d:['executedBySubstitute','executedBy']}).$promise;
