  ...
  angular
    ...
    .config(function($stateProvider) {
        $stateProvider.state('bonita.userTasks', {
          url: '/user/tasks',
          templateUrl: 'features/user/tasks/list/tasks-list.html',
          controller: 'TaskAppCtrl',
          controllerAs: 'TaskAppCtrl'
        });
      }
    )
    ...
    .directive('taskList', [
      ...
      function($q, key, HumanTask, taskListStore, preference, $location, $anchorScroll, $timeout, COLUMNS_SETTINGS ){
        ...
        return {
          ...
          // template: '',
          templateUrl: 'templates/tasklist/taskList.tpl.html',
          // transclude: true,
            ...
            function assignTasks(tasks, fnFilter, assignee ) {
              if (!tasks) {
               ...
               var promises = tasks
                 ...
                 .map(function(task) {
                    /* jshint camelcase: false */
                    return HumanTask.update({id: task.id, assigned_id: assignee}).$promise;
                 });
