(function(){
  ...
  angular
    ...
    .controller('TaskAppCtrl', [
      ...
      'FORM_ERROR_TOO_BIG',
      '$timeout',
      function($modal, $q, store, session, screen, iframe, preference, HumanTask, Process, ngToast, TASK_FILTERS, PAGE_SIZES, FORM_SUCCESS, FORM_ERROR, FORM_ERROR_TOO_BIG, $timeout){
        ...
        this.showTasksFormPopup = function(task){
            ...
            $timeout(function(that, task){
                Process
                    .get({id: store.currentTask.processId})
                    .$promise.then(function (data) {
                        ...
                        if (task.assigned_id !== store.user.user_id) {
                            ...
                            var defered = $q.defer();
                            defered.resolve({assigned_id: store.user.user_id});
                        ...
                        promise.then(function(taskUpdated){
                            ...
                            that.modaleInstance = $modal.open({
                                templateUrl: 'templates/modal/modalForm.tpl.html',
        ...
        this.showTaskDetailsPopup = function(task){
          ...
          this.modaleInstance = $modal.open({
            templateUrl: 'templates/modal/modalDetails.tpl.html',
