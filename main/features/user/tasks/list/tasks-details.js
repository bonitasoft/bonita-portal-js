(function() {
  ...
  .service('taskDetailsHelper', ['taskListStore','preference','HumanTask',function (taskListStore, preference, HumanTask){
      ...
      this.takeReleaseTask = function(task){
        ...
        return HumanTask
          .update({id: task.id, 'assigned_id':assignee})
  ...
  .directive('taskDetails', ['iframe', 'store', 'taskDetailsHelper', 'Process', function (iframe, store, taskDetailsHelper, Process) {
    // Runs during compile
      return {
        restrict: 'AE', // E = Element, A = Attribute, C = Class, M = Comment
        templateUrl: 'templates/taskdetails/taskDetails.tpl.html',
        replace: false,
        scope:{
          currentTask:'=',
          currentCase:'=',
        ...
        //Default inactive value to false
          ...
          scope.$watch('currentCase', function(newCase){
            ...
            /*jshint camelcase: false*/
            Process
              .get({id: scope.currentTask.processId})
