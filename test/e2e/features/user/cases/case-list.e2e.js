  ...
  describe('user case list', function() {
    ...
    describe('sort', function() {
      ...
      it('should order by date asc', function() {
        ...
        expect(caseList.all(by.css('tbody tr')).get(0).all(by.css('td')).getText()).toEqual(['2', 'Pool', '1.0', '10/16/2014 4:05 PM', 'William Jobs', '', 'No value', 'No value', 'No value', 'No value', 'No value', '']);
      ...
      it('should order by date desc', function() {
        tableHeader.get(2).click();
        expect(caseList.all(by.css('tbody tr')).get(0).all(by.css('td')).getText()).toEqual(['1022', 'ProcessX', '2.0', '10/20/2014 10:08 AM', 'System', '', 'No value', 'No value', 'No value', 'No value', 'No value', '']);
