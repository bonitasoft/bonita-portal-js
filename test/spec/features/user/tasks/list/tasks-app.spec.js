...
describe('taskApp', function(){
  ...
  describe('taskApp controller', function(){
    ...
    describe('showTasksFormPopup', function(){
      var $modal;
      var $timeout;
      var task;
      var store;
      ...
      it('should open a modal window if user is assigned', function() {
        ...
        task.assigned_id = mockUser.user_id;
        controller.user = mockUser;
        controller.showTasksFormPopup(task);
      ...
      it('should take the tasks and open a modal window if user is not assigned', function() {
        store.currentTask = task;
      ...
      it('should refresh task and count when dismiss modale', function() {
        store.currentTask = task;
        spyOn(controller,'updateTasks');
        spyOn(controller,'updateCount');
        //force task assign to user
        task.assigned_id = mockUser.user_id;
        controller.showTasksFormPopup(task);
        $timeout.flush();
        // resolve modal Promise
        scope.$digest();
        controller.modaleInstance.dismiss();
    ...
    describe('onFormSubmited', function(){
      ...
      it('should display a file too Big error message', inject(function(FORM_ERROR_TOO_BIG){
        controller.onFormSubmited('error:fileTooBigError');
